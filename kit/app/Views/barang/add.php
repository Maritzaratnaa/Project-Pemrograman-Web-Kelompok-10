...
<body>
    ...
    <section class="tambah-container">
        ...
        <form action="<?= site_url('barang/store/' . $kategori) ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary" style="background-color:#F7CACA; color:black">Add Product</button>
        </form>
    </section>
    <footer>
